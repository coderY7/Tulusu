<template>
	<view class="update-mask flex-center">
		<view class="upcontent botton-radius">
			<view class="content-top">
				<view class="content-top-text">
					<text class="">Discover new version v{{data.edition_name}}</text>
					<text class="version">current version：{{version}}</text>
				</view>
			...
			<view class="content-body">
				...
				<view class="title"><text>update</text></view>
				<view class="body">
				...
				<view class="footer flex-center">
					<view class="progress-box flex-column" v-if="!updateBtn">
						...
						<view><text class="fs24">Downloading ({{downloadedSize}}/{{packageFileSize}}M)</text></view>
					</view>

					<button class="content-button" style="border: none;color: #fff;" plain @click="confirm" v-if="updateBtn">Upgrade Now</button>
				</view>
			</view>
...
export default {
	data() {
		return {
			...
			data: {
				describe: '1. Fix known issues<br>2. Optimize user experience',
